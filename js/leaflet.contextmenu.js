/*
    https://github.com/aratcliffe/Leaflet.contextmenu/blob/master/dist/leaflet.contextmenu.js
    ...
    _showContextMenu: function (e) {
      ...
      if (this._map.contextmenu) {
        ...
        for (i = 0, l = this.options.contextmenuItems.length; i < l; i++) {
          ...
          this._items.push(
            this._map.contextmenu.insertItem(itemOptions, itemOptions.index)
          );
        }
